...
data class NotificationSettings(val alerts: Boolean, var popActive: Boolean, var pop: Float,
                                var windActive: Boolean, var wind_speed: Float,
                                var humidityActive: Boolean, var humidity: Int)